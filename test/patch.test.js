...
describe("Simple Patch", () => {
  ...
  const onePlusTwo = CONSTANT_ONE.addToConstantNumber("OnValue", 2, {
    SetValue: result,
  });
  ...
  it("should save", async () => {
    await patch.save("./_test.entity.patch.json", {
      spaces: 0,
      includeSchema: false,
    });
    ...
    assert.ok(
      JSON.parse(
        await readFile("./_test.entity.patch.json", { encoding: "utf-8" }),
      ),
    );

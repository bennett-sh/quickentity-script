...
export class Entity {
  ...
  public addTimer(
    ...
    return this.addChild({
      ...
      name,
      factory:
        "[assembly:/_pro/design/logic.template?/timersimple.entitytemplate].pc_entitytype",
      blueprint:
        "[assembly:/_pro/design/logic.template?/timersimple.entitytemplate].pc_entityblueprint",
      properties: {
        "Delay time (ms)": {
          type: "int32",
          value: timeMS,

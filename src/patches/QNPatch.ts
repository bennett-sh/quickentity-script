...
import {
  ...
  PatchAction_AddExternalSceneData,
  PatchAction_AddExtraBlueprintDependencyData,
  PatchAction_AddExtraFactoryDependencyData,
  PatchAction_AddInputCopyConnectionData,
  PatchAction_AddOutputCopyConnectionData,
  PatchAction_AddOverrideDeleteData,
  ...
  PatchAction_AddPropertyOverrideConnectionData,
  PatchAction_AddPropertyOverrideData,
  PatchAction_AddPSPropertyData,
  PatchAction_AddSubsetData,
  PatchAction_CustomPatch,
  ...
  PatchAction_RemoveEntityByIDData,
  PatchAction_RemoveEventConnectionData,
  PatchAction_RemoveExposedEntityData,
  PatchAction_RemoveExposedInterfaceData,
  PatchAction_RemoveExternalSceneData,
  PatchAction_RemoveExtraBlueprintDependencyData,
  PatchAction_RemoveExtraFactoryDependencyData,
  PatchAction_RemoveInputCopyConnectionData,
  PatchAction_RemoveOutputCopyConnectionData,
  PatchAction_RemoveOverrideDeleteData,
  ...
  PatchAction_RemovePropertyByNameData,
  PatchAction_RemovePropertyOverrideConnectionData,
  PatchAction_RemovePropertyOverrideData,
  ...
  PatchAction_SetRootEntityData,
  PatchAction_SetSubTypeData,
...
export class QNPatch {
  ...
  public addEntity(entityConfig: ICreateEntity): PatchEntity {
    ...
    this.addPatch<PatchAction_AddEntityData>(PatchAction.ADD_ENTITY, {
      ...entityConfig,
      name,
      id,
    });
  ...
  public setRootEntity(entity: string | PatchEntity): this {
    this.addPatch<PatchAction_SetRootEntityData>(
      PatchAction.SET_ROOT_ENTITY,
      entity,
    );
    return this;
  }
  ...
  public removeEntityByID(entity: string | PatchEntity): this {
    this.addPatch<PatchAction_RemoveEntityByIDData>(
      PatchAction.REMOVE_ENTITY_BY_ID,
      entity,
    );
    return this;
  }
  ...
  public setSubType(subType: TSubType): this {
    this.addPatch<PatchAction_SetSubTypeData>(
      PatchAction.SET_SUB_TYPE,
      subType,
    );
    return this;
  }
  ...
  public addExtraBlueprintDependency(dependency: TDependency): this {
    this.addPatch<PatchAction_AddExtraBlueprintDependencyData>(
      PatchAction.ADD_EXTRA_BLUEPRINT_DEPENDENCY,
      dependency,
    );
    return this;
  }
  ...
  public removeExtraBlueprintDependency(dependency: TDependency): this {
    this.addPatch<PatchAction_RemoveExtraBlueprintDependencyData>(
      PatchAction.REMOVE_EXTRA_BLUEPRINT_DEPENDENCY,
      dependency,
    );
    return this;
  }
  ...
  public addExtraFactoryDependency(dependency: TDependency): this {
    this.addPatch<PatchAction_AddExtraFactoryDependencyData>(
      PatchAction.ADD_EXTRA_FACTORY_DEPENDENCY,
      dependency,
    );
    return this;
  }
  ...
  public removeExtraFactoryDependency(dependency: TDependency): this {
    this.addPatch<PatchAction_RemoveExtraFactoryDependencyData>(
      PatchAction.REMOVE_EXTRA_FACTORY_DEPENDENCY,
      dependency,
    );
    return this;
  }
  ...
  public addExternalScene(scene: string): this {
    this.addPatch<PatchAction_AddExternalSceneData>(
      PatchAction.ADD_EXTERNAL_SCENE,
      scene,
    );
    return this;
  }
  ...
  public removeExternalScene(scene: string): this {
    this.addPatch<PatchAction_RemoveExternalSceneData>(
      PatchAction.REMOVE_EXTERNAL_SCENE,
      scene,
    );
    return this;
  }
  ...
  public addPropertyOverride(override: IPropertyOverride): this {
    this.addPatch<PatchAction_AddPropertyOverrideData>(
      PatchAction.ADD_PROPERTY_OVERRIDE,
      override,
    );
    return this;
  }
  ...
  public removePropertyOverride(override: IPropertyOverride): this {
    this.addPatch<PatchAction_RemovePropertyOverrideData>(
      PatchAction.REMOVE_PROPERTY_OVERRIDE,
      override,
    );
    return this;
  }

  public addPropertyOverrideConnection(
    connection: IPropertyOverrideConnection,
  ): this {
    this.addPatch<PatchAction_AddPropertyOverrideConnectionData>(
      PatchAction.ADD_EXTERNAL_SCENE,
      connection,
    );
    return this;
  ...
  public removePropertyOverrideConnection(
    connection: IPropertyOverrideConnection,
  ): this {
    this.addPatch<PatchAction_RemovePropertyOverrideConnectionData>(
      PatchAction.REMOVE_EXTERNAL_SCENE,
      connection,
    );
    return this;
  ...
  public addOverrideDelete(ref: TRef | TRef[]): this {
    this.addPatch<PatchAction_AddOverrideDeleteData>(
      PatchAction.ADD_OVERRIDE_DELETE,
      ref,
    );
    return this;
  }
  ...
  public removeOverrideDelete(ref: TRef | TRef[]): this {
    this.addPatch<PatchAction_RemoveOverrideDeleteData>(
      PatchAction.REMOVE_OVERRIDE_DELETE,
      ref,
    );
    return this;
  }
  ...
  public addComment(name: string, text: string, parent: TRef): this {
    this.addPatch<PatchAction_AddCommentData>(PatchAction.ADD_COMMENT, {
      name,
      text,
      parent,
    });
  ...
  public removeComment(name: string, text: string, parent: TRef): this {
    this.addPatch<PatchAction_RemoveCommentData>(PatchAction.REMOVE_COMMENT, {
      name,
      text,
      parent,
    });
  ...
  public buildPatch(options: Partial<QNSaveOptions> = {}) {
    ...
    return buildJSON({
      ...
      .setIf(
        ...
        "$schema",
        "https://raw.githubusercontent.com/atampy25/simple-mod-framework/main/Mod%20Manager/src/lib/entity-patch-schema.json",
      )
      .build();
  }
    ...
    return this._patches.map((patch) => {
      switch (patch.action) {
        case PatchAction.ADD_ENTITY: {
          ...
          return [
            {
              AddEntity: [data.id, buildJSON(data).strip("id").build()],
            },
          ];
        }
          ...
          if (data.on instanceof Array) {
            return data.on.map((on) => ({
              SubEntityOperation: [
                data.target,
                {
                  AddEventConnection: [data.when, data.do, ensureID(on)],
                },
              ],
            }));
          } else {
            return [
              {
                SubEntityOperation: [
                  data.target,
                  {
                    AddEventConnection: [data.when, data.do, ensureID(data.on)],
                  },
                ],
              },
            ];
        ...
        case PatchAction.REMOVE_PLATFORM_SPECIFIC_PROPERTIES_FOR_PLATFORM: {
          const data =
            patch.data as PatchAction_RemovePSPropertiesForPlatformData;
          return [
            {
              SubEntityOperation: [
                data.target,
                {
                  RemovePlatformSpecificPropertiesForPlatform: [data.platform],
                },
              ],
            },
          ];
          ...
          return [
            {
              SubEntityOperation: [
                data.target,
                {
                  AddProperty: [data.name, data.property],
                },
              ],
            },
          ];
          ...
          return [
            {
              SubEntityOperation: [
                data.target,
                {
                  SetPropertyType: [data.name, data.type],
                },
              ],
            },
          ];
          ...
          return [
            {
              SubEntityOperation: [
                data.target,
                {
                  SetPropertyPostInit: [data.name, data.postInit],
                },
              ],
            },
          ];
                ...
                data.target,
                {
                  PatchArrayPropertyValue: [
                    ...
                    data.operations.map((operation) =>
                      Object.fromEntries(
                        Object.entries(operation).map(([op, data]) => {
                          if (op === "AddItem" || op === "RemoveItemByValue")
                            data = ensureID(data);
                          if (op === "AddItemAfter" || op === "AddItemBefore")
                            data = data.map((x) => ensureID(x));
                          return [op, data];
                        }),
                      ),
                    ),
        ...
        case PatchAction.REMOVE_PIN_CONNECTION_OVERRIDE: {
          const data =
            patch.data as PatchAction_RemovePinConnectionOverrideData;
          return [
            {
              SubEntityOperation: [
                data.target,
        ...
        case PatchAction.ADD_PIN_CONNECTION_OVERRIDE_DELETE: {
          const data =
            patch.data as PatchAction_AddPinConnectionOverrideDeleteData;
          return [
            {
              SubEntityOperation: [
                data.target,
              ...
              SubEntityOperation: [
                data.target,
                {
                  SetExposedEntity: [
                    ...
                    {
                      ...data.entity,
                      refersTo: data.entity.isArray
                        ? data.entity.refersTo.map((x) => ensureID(x))
                        : ensureID(data.entity.refersTo as TRef),
                    },
                  ],
                },
              ],
          ...
          return [
            {
              SubEntityOperation: [
                data.target,
                {
                  SetExposedInterface: [data.name, data.inf],
                },
              ],
            },
          ];
        ...
        case PatchAction.REMOVE_PIN_CONNECTION_OVERRIDE_DELETE: {
          const data =
            patch.data as PatchAction_RemovePinConnectionOverrideDeleteData;
          return [
            {
              SubEntityOperation: [
                data.target,
          ...
          return [
            {
              SubEntityOperation: [
                data.target,
                {
                  AddPropertyAliasConnection: [data.name, data.alias],
                },
              ],
            },
          ];
        ...
        case PatchAction.REMOVE_CONNECTION_FOR_PROPERTY_ALIAS: {
          const data =
            patch.data as PatchAction_RemoveConnectionForPropertyAliasData;
          return [
            {
              SubEntityOperation: [
                data.target,
                {
                  RemoveConnectionForPropertyAlias: [data.name, data.alias],
                },
              ],
            },
          ];
        ...
        case PatchAction.REMOVE_ALL_EVENT_CONNECTIONS_FOR_EVENT: {
          const data =
            patch.data as PatchAction_RemoveAllEventConnectionsForEventData;
          return [
            {
              SubEntityOperation: [
                data.target,
        ...
        case PatchAction.REMOVE_ALL_EVENT_CONNECTIONS_FOR_TRIGGER: {
          const data =
            patch.data as PatchAction_RemoveAllEventConnectionsForTriggerData;
          return [
            {
              SubEntityOperation: [
                data.target,
                {
                  RemoveAllEventConnectionsForTrigger: [data.a, data.b],
                },
              ],
            },
          ];
        ...
        case PatchAction.REMOVE_ALL_INPUT_COPY_CONNECTIONS_FOR_INPUT: {
          const data =
            patch.data as PatchAction_RemoveAllInputCopyConnectionsForInputData;
          return [
            {
              SubEntityOperation: [
                data.target,
        ...
        case PatchAction.REMOVE_ALL_INPUT_COPY_CONNECTIONS_FOR_TRIGGER: {
          const data =
            patch.data as PatchAction_RemoveAllInputCopyConnectionsForTriggerData;
          return [
            {
              SubEntityOperation: [
                data.target,
                {
                  RemoveAllInputCopyConnectionsForTrigger: [data.a, data.b],
                },
              ],
            },
          ];
        ...
        case PatchAction.REMOVE_ALL_OUTPUT_COPY_CONNECTIONS_FOR_OUTPUT: {
          const data =
            patch.data as PatchAction_RemoveAllOutputCopyConnectionsForPropagate;
          return [
            {
              SubEntityOperation: [
                data.target,
                {
                  RemoveAllOutputCopyConnectionsForPropagate: [data.a, data.b],
                },
              ],
            },
          ];
        ...
        case PatchAction.REMOVE_ALL_OUTPUT_COPY_CONNECTIONS_FOR_PROPAGATE: {
          const data =
            patch.data as PatchAction_RemoveAllOutputCopyConnectionsForOutput;
          return [
            {
              SubEntityOperation: [
                data.target,
        ...
        case PatchAction.SET_ROOT_ENTITY: {
          return [
            {
              SetRootEntity: ensureID(
                patch.data as PatchAction_SetRootEntityData,
              ),
            },
          ];
        }
        ...
        case PatchAction.REMOVE_ENTITY_BY_ID: {
          return [
            {
              RemoveEntityByID: ensureID(
                patch.data as PatchAction_RemoveEntityByIDData,
              ),
            },
          ];
        }
          ...
          return [
            {
              SubEntityOperation: [
                data.target,
                {
                  AddInputCopyConnection: [data.a, data.b, ensureID(data.to)],
                },
              ],
            },
          ];
          ...
          if (data.on instanceof Array) {
            return data.on.map((on) => ({
              SubEntityOperation: [
                data.target,
                {
                  RemoveEventConnection: [data.when, data.do, ensureID(on)],
                },
              ],
            }));
          } else {
        ...
        case PatchAction.ADD_EXTRA_BLUEPRINT_DEPENDENCY: {
          const data =
            patch.data as PatchAction_AddExtraBlueprintDependencyData;
          return [
            {
        ...
        case PatchAction.REMOVE_EXTRA_BLUEPRINT_DEPENDENCY: {
          const data =
            patch.data as PatchAction_RemoveExtraBlueprintDependencyData;
          return [
            {
        ...
        case PatchAction.REMOVE_EXTRA_FACTORY_DEPENDENCY: {
          const data =
            patch.data as PatchAction_RemoveExtraFactoryDependencyData;
          return [
            {
          ...
          return [
            {
              SubEntityOperation: [
                data.target,
                {
                  AddOutputCopyConnection: [data.a, data.b, ensureID(data.to)],
                },
              ],
            },
          ];
        ...
        default:
          throw new Error(
            `patch ${PatchAction[patch.action]} has not been implemented yet! please use custom patches until then`,
          );
      }
    });
  }

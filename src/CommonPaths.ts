...
export const CommonPaths = {
  ...
  GlobalData_Base: getPath('[assembly:/_pro/scenes/bricks/globaldatabase.brick]'),
  ...
  Agent47: getPath('[assembly:/_pro/characters/templates/hero/agent47/agent47.template?/agent47_default.entitytemplate]'),
  NPC: getPath('[assembly:/templates/gameplay/ai2/actors.template?/npcactor.entitytemplate]'),

  Safehouse: getMissionBrickPath(Location.Safehouse, 'mission_vanilla'),
  EvergreenSetup: getPath('[assembly:/_pro/scenes/bricks/evergreen_setup.brick]'),

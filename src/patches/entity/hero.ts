...
declare module "./_index.js" {
  interface PatchEntity {
    ...
    setHeroOutfit(
      ...
      onHero?: (root: PatchEntity) => IEventTriggers,
    ): PatchEntity;
  }
}

PatchEntity.prototype.getHero = function (
  triggers: IEventTriggers,
  entityConfig?: Partial<ICreateChildEntity>,
) {
...
PatchEntity.prototype.setHeroOutfit = function (
  outfitRepositoryID: string,
  onHero?: (root: PatchEntity) => IEventTriggers,
) {
  ...
  if (onHeroTriggers?.hasOwnProperty("SetHero"))
    console.warn("WARN: you can't use SetHero on setHeroOutfit->onHero");

  root.getHero(
    deepMerge(onHeroTriggers, {

...
Entity.prototype.addToConstantNumber = function (
  when: string,
  add: number,
  outputs: IEventTriggers,
): Entity {
...
Entity.prototype.addToVariableNumber = function (
  whenA: string,
  whenB: string,
  b: TRef,
  outputs: IEventTriggers,
...
Entity.prototype.subtractFromConstantNumber = function (
  when: string,
  add: number,
  outputs: IEventTriggers,
): Entity {
...
Entity.prototype.subtractFromVariableNumber = function (
  whenA: string,
  whenB: string,
  b: TRef,
  outputs: IEventTriggers,
...
Entity.prototype.multiplyWithConstantNumber = function (
  when: string,
  mul: number,
  outputs: IEventTriggers,
): Entity {
...
Entity.prototype.multiplyWithVariableNumber = function (
  whenA: string,
  whenB: string,
  b: TRef,
  outputs: IEventTriggers,
...
Entity.prototype.divideByConstantNumber = function (
  when: string,
  div: number,
  outputs: IEventTriggers,
): Entity {
...
Entity.prototype.divideByVariableNumber = function (
  whenA: string,
  whenB: string,
  b: TRef,
  outputs: IEventTriggers,
